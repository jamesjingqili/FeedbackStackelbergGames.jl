...
turn_on_equality_constraints = 1.0

Hx1 = [1.0 0 0 0]*turn_on_equality_constraints
Hx2 = [1.0 0 0 0]*turn_on_equality_constraints
Hu1 = [1.0 0 0 0]*turn_on_equality_constraints
Hu2 = [1.0 0 0 0]*turn_on_equality_constraints
h1 = [-1.0]*turn_on_equality_constraints
h2 = [-1.0]*turn_on_equality_constraints
Hx1_terminal = [0 1.0 0 0]*turn_on_equality_constraints
Hx2_terminal = [0 1.0 0 0]*turn_on_equality_constraints
h1_terminal = [-1.]*turn_on_equality_constraints
h2_terminal = [-1.]*turn_on_equality_constraints
...
turn_on_inequality_constraints = 1.0
Gx1 = [0 0 1.0 0]*turn_on_inequality_constraints
Gx2 = [0 0 1.0 0]*turn_on_inequality_constraints
Gu1 = [0 0 0 0]*turn_on_inequality_constraints
Gu2 = [0 0 0 0]*turn_on_inequality_constraints
g1 = [-1.8]*turn_on_inequality_constraints
g2 = [-1.8]*turn_on_inequality_constraints
Gx1_terminal = [0 0 0 1.0]*turn_on_inequality_constraints;
Gx2_terminal = [0 0 0 1.0]*turn_on_inequality_constraints;
g1_terminal = [-1.0]*turn_on_inequality_constraints;
g2_terminal = [-1.0]*turn_on_inequality_constraints;
...
if turn_on_inequality_constraints == 1.0
    for t = 1:horizon+1
        if t == horizon+1
            calibrated_γ[t] =  [
                diagm(
